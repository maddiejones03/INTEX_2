...
export default function HomeVisitation() {
  ...
  function upcomingStatusLabel(v: HomeVisit): string {
    const day = visitDayMs(v.visitDate);
    const today = startOfTodayMs();
    if (day != null && day >= today) return 'Scheduled';
    if (asBool(v.followUpNeeded)) return 'Follow-up due';
    return '—';
  }
    ...
    <div className="admin-page">
      <div className="admin-page-header">
        <div>
          ...
          <p>
            Log field visits and review history. <strong>Upcoming visits &amp; follow-ups</strong> lists visits scheduled for
            today or later, plus older visits still flagged for follow-up. <strong>Past visitations</strong> is completed
            history in this view.
          </p>
          {total > PAGE_SIZE && (
